...
public class AddActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    private int mSupplieName = InventoryEntry.SUPPLIER_First;
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (!TextUtils.isEmpty(selection)) {
                    if (selection.equals(getString(R.string.supplier_amazon))) {
                        mSupplieName = InventoryEntry.SUPPLIER_SECOND;
                    } else if (selection.equals(getString(R.string.supplier_jarirr))) {
                        mSupplieName = InventoryEntry.SUPPLIER_THIRD;
                    } else if (selection.equals(getString(R.string.supplier_obeikan))) {
                        mSupplieName = InventoryEntry.SUPPLIER_FORTH;
                    } else {
                        mSupplieName = InventoryEntry.SUPPLIER_First;
                    }
                }
            }
    ...
    private void saveProduct() {
        ...
        if (mCurrentProductUri == null) {
            ...
            /*if (mSupplieName == InventoryEntry.SUPPLIER_First) {
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor cursor) {
        ...
        if (cursor.moveToFirst()) {
            ...
            switch (currentSupplierName) {
                case InventoryEntry.SUPPLIER_SECOND:
                    mProductSupplieNameSpinner.setSelection(1);
                    break;
                case InventoryEntry.SUPPLIER_THIRD:
                    mProductSupplieNameSpinner.setSelection(2);
                    break;
                case InventoryEntry.SUPPLIER_FORTH:
