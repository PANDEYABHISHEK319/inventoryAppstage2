        ...
        if (cursor.moveToFirst()) {
            ...
            switch (currentSupplierName) {
                case InventoryEntry.SUPPLIER_SECOND:
                    mProductSupplieNameSpinner.setText(getText(R.string.supplier_SECOND));
                    break;
                case InventoryEntry.SUPPLIER_THIRD:
                    mProductSupplieNameSpinner.setText(getText(R.string.supplier_THIRD));
                    break;
                case InventoryEntry.SUPPLIER_FORTH:
                    mProductSupplieNameSpinner.setText(getText(R.string.supplier_FOURTH));
                    break;
                default:
                    mProductSupplieNameSpinner.setText(getText(R.string.supplier_FIRST));
                    break;
            }
